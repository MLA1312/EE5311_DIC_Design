module bka (CLK,
 ...
 sky130_fd_sc_hd__nand2_2 _087_ (.A(\x33.B ),
    .B(\x33.A ),
    .Y(_038_));
 sky130_fd_sc_hd__or2_2 _088_ (.A(\x33.B ),
    .B(\x33.A ),
    .X(_039_));
 sky130_fd_sc_hd__nand2_2 _089_ (.A(_038_),
    .B(_039_),
    .Y(_040_));
 sky130_fd_sc_hd__and2_2 _090_ (.A(\x4.B ),
    .B(\x4.A ),
    .X(_041_));
 sky130_fd_sc_hd__nor2_2 _091_ (.A(\x4.B ),
    .B(\x4.A ),
    .Y(_042_));
 sky130_fd_sc_hd__or2_2 _092_ (.A(_041_),
    .B(_042_),
    .X(_043_));
 sky130_fd_sc_hd__nand2_2 _093_ (.A(\x3.B ),
    .B(\x3.A ),
    .Y(_044_));
 sky130_fd_sc_hd__or2_2 _094_ (.A(\x3.B ),
    .B(\x3.A ),
    .X(_045_));
 sky130_fd_sc_hd__nand2_2 _095_ (.A(_044_),
    .B(_045_),
    .Y(_046_));
 sky130_fd_sc_hd__or2_2 _096_ (.A(_043_),
    .B(_046_),
    .X(_047_));
 sky130_fd_sc_hd__xor2_2 _097_ (.A(\x7.B ),
    .B(\x7.A ),
    .X(_048_));
 sky130_fd_sc_hd__nand2_2 _098_ (.A(\x8.B ),
    .B(\x8.A ),
    .Y(_049_));
 sky130_fd_sc_hd__or2_2 _099_ (.A(\x8.B ),
    .B(\x8.A ),
    .X(_050_));
 sky130_fd_sc_hd__and4_2 _100_ (.A(\x49.G1 ),
    .B(_048_),
    .C(_049_),
    .D(_050_),
    .X(_051_));
 sky130_fd_sc_hd__or2_2 _101_ (.A(\x5.B ),
    .B(\x5.A ),
    .X(_052_));
 sky130_fd_sc_hd__and2_2 _102_ (.A(\x6.B ),
    .B(\x6.A ),
    .X(_053_));
 sky130_fd_sc_hd__and2_2 _103_ (.A(\x5.B ),
    .B(\x5.A ),
    .X(_054_));
 sky130_fd_sc_hd__a21o_2 _104_ (.A1(_052_),
    .A2(_053_),
    .B1(_054_),
    .X(_055_));
 sky130_fd_sc_hd__a22o_2 _105_ (.A1(\x8.B ),
    .A2(\x8.A ),
    .B1(\x7.B ),
    .B2(\x7.A ),
    .X(_056_));
 sky130_fd_sc_hd__o21a_2 _106_ (.A1(\x7.B ),
    .A2(\x7.A ),
    .B1(_056_),
    .X(_057_));
 sky130_fd_sc_hd__o31a_2 _107_ (.A1(\x6.B ),
    .A2(\x6.A ),
    .A3(_054_),
    .B1(_052_),
    .X(_058_));
 sky130_fd_sc_hd__o31ai_2 _108_ (.A1(_051_),
    .A2(_055_),
    .A3(_057_),
    .B1(_058_),
    .Y(_059_));
 sky130_fd_sc_hd__xor2_2 _109_ (.A(\x2.B ),
    .B(\x2.A ),
    .X(_060_));
 sky130_fd_sc_hd__inv_2 _110_ (.A(_060_),
    .Y(_061_));
 sky130_fd_sc_hd__or2_2 _111_ (.A(\x1.B ),
    .B(\x1.A ),
    .X(_062_));
 sky130_fd_sc_hd__nand2_2 _112_ (.A(\x1.B ),
    .B(\x1.A ),
    .Y(_063_));
 sky130_fd_sc_hd__nand2_2 _113_ (.A(_062_),
    .B(_063_),
    .Y(_064_));
 sky130_fd_sc_hd__a22o_2 _114_ (.A1(\x4.B ),
    .A2(\x4.A ),
    .B1(\x3.B ),
    .B2(\x3.A ),
    .X(_065_));
 sky130_fd_sc_hd__and3_2 _115_ (.A(_045_),
    .B(_060_),
    .C(_065_),
    .X(_066_));
 sky130_fd_sc_hd__a22o_2 _116_ (.A1(\x2.B ),
    .A2(\x2.A ),
    .B1(\x1.B ),
    .B2(\x1.A ),
    .X(_067_));
 sky130_fd_sc_hd__o21ai_2 _117_ (.A1(_066_),
    .A2(_067_),
    .B1(_062_),
    .Y(_068_));
 sky130_fd_sc_hd__o41ai_2 _118_ (.A1(_047_),
    .A2(_059_),
    .A3(_061_),
    .A4(_064_),
    .B1(_068_),
    .Y(_069_));
 sky130_fd_sc_hd__xor2_2 _119_ (.A(\x12.B ),
    .B(\x12.A ),
    .X(_070_));
 sky130_fd_sc_hd__and2_2 _120_ (.A(\x11.B ),
    .B(\x11.A ),
    .X(_071_));
 sky130_fd_sc_hd__or2_2 _121_ (.A(\x11.B ),
    .B(\x11.A ),
    .X(_072_));
 sky130_fd_sc_hd__and2b_2 _122_ (.A_N(_071_),
    .B(_072_),
    .X(_073_));
 sky130_fd_sc_hd__and2_2 _123_ (.A(_070_),
    .B(_073_),
    .X(_074_));
 sky130_fd_sc_hd__nand2_2 _124_ (.A(\x10.B ),
    .B(\x10.A ),
    .Y(_075_));
 sky130_fd_sc_hd__or2_2 _125_ (.A(\x10.B ),
    .B(\x10.A ),
    .X(_076_));
 sky130_fd_sc_hd__and2_2 _126_ (.A(_075_),
    .B(_076_),
    .X(_077_));
 sky130_fd_sc_hd__and2_2 _127_ (.A(\x9.B ),
    .B(\x9.A ),
    .X(_078_));
 sky130_fd_sc_hd__nor2_2 _128_ (.A(\x9.B ),
    .B(\x9.A ),
    .Y(_079_));
 sky130_fd_sc_hd__nor2_2 _129_ (.A(_078_),
    .B(_079_),
    .Y(_080_));
 sky130_fd_sc_hd__and4_2 _130_ (.A(_069_),
    .B(_074_),
    .C(_077_),
    .D(_080_),
    .X(_081_));
 sky130_fd_sc_hd__a31o_2 _131_ (.A1(\x12.B ),
    .A2(\x12.A ),
    .A3(_072_),
    .B1(_071_),
    .X(_082_));
 sky130_fd_sc_hd__a21o_2 _132_ (.A1(\x10.B ),
    .A2(\x10.A ),
    .B1(_082_),
    .X(_083_));
 sky130_fd_sc_hd__a31o_2 _133_ (.A1(_076_),
    .A2(_080_),
    .A3(_083_),
    .B1(_078_),
    .X(_084_));
 sky130_fd_sc_hd__or2_2 _134_ (.A(\x35.B ),
    .B(\x35.A ),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _135_ (.A(\x35.B ),
    .B(\x35.A ),
    .Y(_086_));
 sky130_fd_sc_hd__nand2_2 _136_ (.A(_085_),
    .B(_086_),
    .Y(_000_));
 sky130_fd_sc_hd__or2_2 _137_ (.A(\x36.B ),
    .B(\x36.A ),
    .X(_001_));
 sky130_fd_sc_hd__nand2_2 _138_ (.A(\x36.B ),
    .B(\x36.A ),
    .Y(_002_));
 sky130_fd_sc_hd__nand2_2 _139_ (.A(_001_),
    .B(_002_),
    .Y(_003_));
 sky130_fd_sc_hd__nor2_2 _140_ (.A(_000_),
    .B(_003_),
    .Y(_004_));
 sky130_fd_sc_hd__o21ai_2 _141_ (.A1(_081_),
    .A2(_084_),
    .B1(_004_),
    .Y(_005_));
 sky130_fd_sc_hd__nand2_2 _142_ (.A(_086_),
    .B(_002_),
    .Y(_006_));
 sky130_fd_sc_hd__and2_2 _143_ (.A(\x34.B ),
    .B(\x34.A ),
    .X(_007_));
 sky130_fd_sc_hd__a21oi_2 _144_ (.A1(_085_),
    .A2(_006_),
    .B1(_007_),
    .Y(_008_));
 sky130_fd_sc_hd__nor2_2 _145_ (.A(\x34.B ),
    .B(\x34.A ),
    .Y(_009_));
 sky130_fd_sc_hd__a21oi_2 _146_ (.A1(_005_),
    .A2(_008_),
    .B1(_009_),
    .Y(_010_));
 sky130_fd_sc_hd__xnor2_2 _147_ (.A(_040_),
    .B(_010_),
    .Y(\x65.Si ));
 sky130_fd_sc_hd__a21bo_2 _148_ (.A1(_085_),
    .A2(_006_),
    .B1_N(_005_),
    .X(_011_));
 sky130_fd_sc_hd__or2_2 _149_ (.A(_009_),
    .B(_007_),
    .X(_012_));
 sky130_fd_sc_hd__xnor2_2 _150_ (.A(_011_),
    .B(_012_),
    .Y(\x66.Si ));
 sky130_fd_sc_hd__or2_2 _151_ (.A(_081_),
    .B(_084_),
    .X(_013_));
 sky130_fd_sc_hd__a21bo_2 _152_ (.A1(_013_),
    .A2(_001_),
    .B1_N(_002_),
    .X(_014_));
 sky130_fd_sc_hd__xnor2_2 _153_ (.A(_000_),
    .B(_014_),
    .Y(\x67.Si ));
 sky130_fd_sc_hd__xnor2_2 _154_ (.A(_013_),
    .B(_003_),
    .Y(\x68.Si ));
 sky130_fd_sc_hd__and2_2 _155_ (.A(_069_),
    .B(_074_),
    .X(_015_));
 sky130_fd_sc_hd__o21a_2 _156_ (.A1(_015_),
    .A2(_083_),
    .B1(_076_),
    .X(_016_));
 sky130_fd_sc_hd__xor2_2 _157_ (.A(_080_),
    .B(_016_),
    .X(\x69.Si ));
 sky130_fd_sc_hd__nor2_2 _158_ (.A(_015_),
    .B(_082_),
    .Y(_017_));
 sky130_fd_sc_hd__xnor2_2 _159_ (.A(_077_),
    .B(_017_),
    .Y(\x70.Si ));
 sky130_fd_sc_hd__o21a_2 _160_ (.A1(\x12.B ),
    .A2(\x12.A ),
    .B1(_069_),
    .X(_018_));
 sky130_fd_sc_hd__a21oi_2 _161_ (.A1(\x12.B ),
    .A2(\x12.A ),
    .B1(_018_),
    .Y(_019_));
 sky130_fd_sc_hd__xnor2_2 _162_ (.A(_073_),
    .B(_019_),
    .Y(\x71.Si ));
 sky130_fd_sc_hd__xor2_2 _163_ (.A(_069_),
    .B(_070_),
    .X(\x72.Si ));
 sky130_fd_sc_hd__nor2_2 _164_ (.A(_047_),
    .B(_061_),
    .Y(_020_));
 sky130_fd_sc_hd__a22o_2 _165_ (.A1(\x2.B ),
    .A2(\x2.A ),
    .B1(_020_),
    .B2(\x49.G1 ),
    .X(_021_));
 sky130_fd_sc_hd__xor2_2 _166_ (.A(_064_),
    .B(_066_),
    .X(_022_));
 sky130_fd_sc_hd__xnor2_2 _167_ (.A(_021_),
    .B(_022_),
    .Y(\x73.Si ));
 sky130_fd_sc_hd__a21oi_2 _168_ (.A1(_045_),
    .A2(_065_),
    .B1(_060_),
    .Y(_023_));
 sky130_fd_sc_hd__o22ai_2 _169_ (.A1(_047_),
    .A2(_059_),
    .B1(_066_),
    .B2(_023_),
    .Y(_024_));
 sky130_fd_sc_hd__o31a_2 _170_ (.A1(_047_),
    .A2(_059_),
    .A3(_061_),
    .B1(_024_),
    .X(\x74.Si ));
 sky130_fd_sc_hd__o21bai_2 _171_ (.A1(_042_),
    .A2(_059_),
    .B1_N(_041_),
    .Y(_025_));
 sky130_fd_sc_hd__xnor2_2 _172_ (.A(_046_),
    .B(_025_),
    .Y(\x75.Si ));
 sky130_fd_sc_hd__xor2_2 _173_ (.A(_043_),
    .B(_059_),
    .X(\x76.Si ));
 sky130_fd_sc_hd__nand2_2 _174_ (.A(\x5.B ),
    .B(\x5.A ),
    .Y(_026_));
 sky130_fd_sc_hd__nand2_2 _175_ (.A(_052_),
    .B(_026_),
    .Y(_027_));
 sky130_fd_sc_hd__nor2_2 _176_ (.A(\x6.B ),
    .B(\x6.A ),
    .Y(_028_));
 sky130_fd_sc_hd__nor2_2 _177_ (.A(_051_),
    .B(_057_),
    .Y(_029_));
 sky130_fd_sc_hd__o21bai_2 _178_ (.A1(_028_),
    .A2(_029_),
    .B1_N(_053_),
    .Y(_030_));
 sky130_fd_sc_hd__xnor2_2 _179_ (.A(_027_),
    .B(_030_),
    .Y(\x77.Si ));
 sky130_fd_sc_hd__nor2_2 _180_ (.A(_053_),
    .B(_028_),
    .Y(_031_));
 sky130_fd_sc_hd__xnor2_2 _181_ (.A(_031_),
    .B(_029_),
    .Y(\x78.Si ));
 sky130_fd_sc_hd__nand3_2 _182_ (.A(\x49.G1 ),
    .B(_049_),
    .C(_050_),
    .Y(_032_));
 sky130_fd_sc_hd__nand2_2 _183_ (.A(_049_),
    .B(_032_),
    .Y(_033_));
 sky130_fd_sc_hd__xor2_2 _184_ (.A(_048_),
    .B(_033_),
    .X(\x79.Si ));
 sky130_fd_sc_hd__a21o_2 _185_ (.A1(_049_),
    .A2(_050_),
    .B1(\x49.G1 ),
    .X(_034_));
 sky130_fd_sc_hd__and2_2 _186_ (.A(_032_),
    .B(_034_),
    .X(_035_));
 sky130_fd_sc_hd__buf_1 _187_ (.A(_035_),
    .X(\x80.Si ));
 sky130_fd_sc_hd__nor2_2 _188_ (.A(\x33.B ),
    .B(\x33.A ),
    .Y(_036_));
 sky130_fd_sc_hd__o31a_2 _189_ (.A1(_036_),
    .A2(_009_),
    .A3(_008_),
    .B1(_038_),
    .X(_037_));
 sky130_fd_sc_hd__o31ai_2 _190_ (.A1(_040_),
    .A2(_005_),
    .A3(_012_),
    .B1(_037_),
    .Y(\x49.G ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _221_ (.CLK(CLK),
    .D(A[13]),
    .Q(\x35.A ));
 sky130_fd_sc_hd__dfxtp_2 _222_ (.CLK(CLK),
    .D(A[14]),
    .Q(\x34.A ));
 sky130_fd_sc_hd__dfxtp_2 _223_ (.CLK(CLK),
    .D(A[15]),
    .Q(\x33.A ));
 sky130_fd_sc_hd__dfxtp_2 _224_ (.CLK(CLK),
    .D(B[0]),
    .Q(\x8.B ));
 sky130_fd_sc_hd__dfxtp_2 _225_ (.CLK(CLK),
    .D(B[1]),
    .Q(\x7.B ));
 sky130_fd_sc_hd__dfxtp_2 _226_ (.CLK(CLK),
    .D(B[2]),
    .Q(\x6.B ));
 sky130_fd_sc_hd__dfxtp_2 _227_ (.CLK(CLK),
    .D(B[3]),
    .Q(\x5.B ));
 sky130_fd_sc_hd__dfxtp_2 _228_ (.CLK(CLK),
    .D(B[4]),
    .Q(\x4.B ));
 sky130_fd_sc_hd__dfxtp_2 _229_ (.CLK(CLK),
    .D(B[5]),
    .Q(\x3.B ));
 sky130_fd_sc_hd__dfxtp_2 _230_ (.CLK(CLK),
    .D(B[6]),
    .Q(\x2.B ));
 sky130_fd_sc_hd__dfxtp_2 _231_ (.CLK(CLK),
    .D(B[7]),
    .Q(\x1.B ));
 sky130_fd_sc_hd__dfxtp_2 _232_ (.CLK(CLK),
    .D(B[8]),
    .Q(\x12.B ));
 sky130_fd_sc_hd__dfxtp_2 _233_ (.CLK(CLK),
    .D(B[9]),
    .Q(\x11.B ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _239_ (.CLK(CLK),
    .D(B[15]),
    .Q(\x33.B ));
 sky130_fd_sc_hd__dfxtp_2 _240_ (.CLK(CLK),
    .D(Cin),
    .Q(\x49.G1 ));
